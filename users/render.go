...
func renderCreateGroupPage(w http.ResponseWriter, r *http.Request)  {
	http.Error(w, "Create group page not implemented", 501);
}
func renderFriendListPage(w http.ResponseWriter, r *http.Request)  {
	http.Error(w, "Friend list page not implemented", 501);
}
func renderGroupPage(w http.ResponseWriter, r *http.Request, id uint32)  {
...
func renderProfilePage(w http.ResponseWriter, r *http.Request, id uint32)  {
	http.Error(w, "Profile page not implemented", 501);
}
